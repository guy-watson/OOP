 ...
 *<h1>Rider.java</h1>
 * 
 * Rider is a public class that holds the rider object information
 *<p>
...
public class Rider {
	 ...
	 * @return yearOfBirth An integer representing the year that the rider
	 * 		was born
	 */
	...
	/**
	 * Gets the riderId
	 * @return riderId An integer representing the unique riderId of the rider
	 */
	...
	/**
	 * Gets the teamId
	 * @return teamId An integer representing the unique teamId that the rider belongs to
	 */
